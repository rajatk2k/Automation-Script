...
public class ContactUs {
    static {
        System.setProperty("webdriver.chrome.driver",
                "C:\\\\Users\\\\rajat.kulkarni\\\\Downloads\\\\chromedriver_win32\\\\chromedriver.exe");
    }
    WebDriver driver;
    ...
    public void enterName() throws InterruptedException {
        driver.findElement(By.name("name")).sendKeys("Rajat");
    }
    @Test(priority = 3)
    public void enterMail() throws InterruptedException {
        driver.findElement(By.name("email")).sendKeys("rajat@gmail.com");
    }
    @Test(priority = 4)
    public void enterPhoneNumber() throws InterruptedException {
        driver.findElement(By.name("phone")).sendKeys("8798456789");
    }
    @Test(priority = 5)
    public void enterMessage() throws InterruptedException {
        driver.findElement(By.name("message")).sendKeys("Hello this is rajat");
        Thread.sleep(5000);
    }
    @Test(priority = 6)
